...
async def handle_websocket(ws_queue, speaker_queue):
    ...
    async with websockets.connect(ws_endpoint) as ws:
        ...
        with open(PJ(this_dir, 'audio/response.mp3'), 'rb') as fd:
...
def main():
    ...
    try:
        ...
        with open(PJ(this_dir, 'audio/deactivate.mp3'), 'rb') as fd:
            simple_player.play_bytes(fd)
...
if __name__ == '__main__':
    with open(PJ(this_dir, 'audio/init.mp3'), 'rb') as fd:
        simple_player.play_bytes(fd)
